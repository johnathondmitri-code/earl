#!/usr/bin/env python3
"""Build the Earl Skills Index — a centralized JSON catalog of all skills.
...
`earl skills search/install` can use it without hitting the GitHub API.
...
# Ensure EARL_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Earl Skills Index...", flush=True)
