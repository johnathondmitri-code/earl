...
DEFAULT_DATASETS = [
    ...
    "NousResearch/earl-megascience-sft1",
    "NousResearch/Earl-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Earl-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-earl"
]
