...
VERSION_FILE = REPO_ROOT / "earl_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+earl-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "earl@nousresearch.com": "NousResearch",
    ...
    "earl@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (EARL_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (EARL_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: earl-eval community link)
    ...
    "earlagent26@gmail.com": "earlagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+earlagent26@users.noreply.github.com": "earlagent26",
    ...
    "vigo@earl": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "earl@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/earl",
    ...
    lines.append(f"# Earl Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Earl Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Earl Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Earl Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Earl Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Earl Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Earl Agent v{new_version} ({calver_date})' "
