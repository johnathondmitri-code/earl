...
Verifies that:
 ...
 2. User plugins at $EARL_HOME/plugins/model-providers/<name>/ override bundled
...
def test_user_plugin_overrides_bundled(tmp_path, monkeypatch):
    ...
    # Point EARL_HOME at a fresh temp dir
...
def test_general_plugin_manager_skips_model_provider_kind(tmp_path, monkeypatch):
    ...
    from earl_cli import plugins as plugin_mod
