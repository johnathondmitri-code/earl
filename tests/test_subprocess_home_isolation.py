...
See: https://github.com/NousResearch/earl/issues/4426
"""
...
class TestGetSubprocessHome:
    """Unit tests for earl_constants.get_subprocess_home()."""
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("EARL_HOME", str(base / "alpha"))
        home_a = get_subprocess_home()

        monkeypatch.setenv("EARL_HOME", str(base / "beta"))
...
class TestMakeRunEnvHomeInjection:
    ...
    def test_context_override_bridges_to_subprocess_env(self, tmp_path, monkeypatch):
        ...
        from earl_constants import reset_hermes_home_override, set_hermes_home_override
        from tools.environments.local import _make_run_env
        ...
        assert result["EARL_HOME"] == str(profile)
...
class TestProfileBootstrap:
    ...
    def test_profile_dirs_includes_home(self):
        from earl_cli.profiles import _PROFILE_DIRS
