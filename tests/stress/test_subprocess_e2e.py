...
This validates the IPC + lifecycle story that mocks can't:
  ...
  - the child process resolves earl_cli.kanban_db on its own
  ...
  - worker logs are captured to EARL_HOME/kanban/logs/<task>.log
    ...
    def _spawn(task, workspace):
        ...
        env = {
            **os.environ,
            ...
            "HOME": home,
            "PYTHONPATH": WT,
            "EARL_KANBAN_TASK": task.id,
            "EARL_KANBAN_WORKSPACE": workspace,
