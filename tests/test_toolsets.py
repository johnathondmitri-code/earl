...
class TestToolsetConsistency:
    ...
    def test_hermes_platforms_share_core_tools(self):
        ...
        """
        platforms = ["earl-cli", "earl-telegram", "earl-discord", "earl-whatsapp", "earl-slack", "earl-signal", "earl-homeassistant"]
...
class TestDefaultPlatformWebSearchCoverage:
    def test_hermes_whatsapp_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("earl-whatsapp")

    def test_hermes_api_server_toolset_includes_web_search(self):
        assert "web_search" in resolve_toolset("earl-api-server")
