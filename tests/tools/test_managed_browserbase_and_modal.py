...
def _enable_managed_nous_tools(monkeypatch):
    ...
    earl_cli.auth and earl_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("earl_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("earl_cli.models.check_nous_free_tier", lambda: False)
