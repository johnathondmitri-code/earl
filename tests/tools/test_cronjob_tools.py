...
class TestCronjobRequirements:
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("EARL_GATEWAY_SESSION", "1")
        monkeypatch.delenv("EARL_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("EARL_INTERACTIVE", raising=False)
        monkeypatch.delenv("EARL_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("EARL_EXEC_ASK", "1")
    ...
    def test_rejects_false_like_interactive_env(self, monkeypatch, false_like_value):
        monkeypatch.setenv("EARL_INTERACTIVE", false_like_value)
        monkeypatch.delenv("EARL_GATEWAY_SESSION", raising=False)
        monkeypatch.delenv("EARL_EXEC_ASK", raising=False)
        assert check_cronjob_requirements() is False
    ...
    @pytest.mark.parametrize(
        "var_name",
        ["EARL_INTERACTIVE", "EARL_GATEWAY_SESSION", "EARL_EXEC_ASK"],
    )
    @pytest.mark.parametrize("false_like_value", ["0", "false", "no", "off"])
    def test_rejects_false_like_any_session_env(
        ...
        for v in ("EARL_INTERACTIVE", "EARL_GATEWAY_SESSION", "EARL_EXEC_ASK"):
