"""Tests for the earl-tools-as-MCP server module surface.
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import earl_tools_mcp_server as m
    ...
    def test_exposed_tools_are_safe_subset(self):
        ...
        from agent.transports.earl_tools_mcp_server import EXPOSED_TOOLS
        forbidden = {
    ...
    def test_kanban_worker_tools_exposed(self):
        """Kanban workers run as `earl chat -q` subprocesses; if they
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.earl_tools_mcp_server as m
