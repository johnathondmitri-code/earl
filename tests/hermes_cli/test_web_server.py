"""Tests for earl_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def _setup_test_client(self, monkeypatch, _isolate_hermes_home):
        """Create a TestClient and isolate the state DB under the test EARL_HOME."""
        try:
        ...
        from earl_cli.web_server import app, _SESSION_HEADER_NAME, _SESSION_TOKEN

        monkeypatch.setattr(earl_state, "DEFAULT_DB_PATH", get_hermes_home() / "state.db")
    ...
    def test_get_status_filters_unconfigured_gateway_platforms(self, monkeypatch):
        ...
        import earl_cli.web_server as web_server
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from earl_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_no_token(self, tmp_path):
        ...
        from starlette.testclient import TestClient
        from earl_cli.web_server import app
        from earl_cli.config import save_env_value
    ...
    def test_reveal_env_var_bad_token(self, tmp_path):
        ...
        from earl_cli.config import save_env_value
        from earl_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from earl_cli.config import save_env_value
        from earl_cli.web_server import _SESSION_TOKEN
    ...
    def test_path_traversal_dotdot_blocked(self):
        ...
        resp = self.client.get("/%2e%2e/earl_cli/web_server.py")
        assert resp.status_code in {200, 404}
        if resp.status_code == 200:
...
class TestBuildSchemaFromConfig:
    def test_produces_expected_field_count(self):
        from earl_cli.web_server import CONFIG_SCHEMA
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from earl_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_profiles_list_falls_back_when_profile_listing_fails(self, monkeypatch):
        from earl_constants import get_hermes_home
        import earl_cli.profiles as profiles_mod
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import earl_cli.skills_config as skills_config
        import earl_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        import earl_cli.tools_config as tools_config
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from earl_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from earl_cli.web_server import _denormalize_config_from_web
...
class TestModelInfoEndpoint:
    ...
    def test_model_info_with_dict_config(self, monkeypatch):
        import earl_cli.web_server as ws
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from earl_cli.web_server import _normalise_theme_definition
...
class TestDiscoverUserThemes:
    """Tests for _discover_user_themes() — scans ~/.earl/dashboard-themes/."""
...
# or ``sh -c 'printf …'``) instead of the real ``earl --tui`` binary.  The
...
class TestPtyWebSocket:
    ...
    def test_resolve_chat_argv_uses_dashboard_scroll_env(self, monkeypatch):
        ...
        assert env["EARL_TUI_INLINE"] == "1"
        assert env["EARL_TUI_DISABLE_MOUSE"] == "1"
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from earl_cli.pty_bridge import PtyUnavailableError
        ...
        import earl_cli.web_server as ws_mod
    ...
    def test_channel_param_propagates_sidecar_url(self, monkeypatch):
        ...
        EARL_TUI_SIDECAR_URL env var pointing back at /api/pub on the
    ...
    def test_pub_broadcasts_to_events_subscribers(self, monkeypatch):
        ...
        import time
        from urllib.parse import urlencode
        from earl_cli import web_server as ws_mod
