...
class TestGmiAliases:
    ...
    def test_providers_normalize_provider(self):
        from earl_cli.providers import normalize_provider as normalize_provider_in_providers
...
class TestGmiModelCatalog:
    ...
    def test_provider_model_ids_falls_back_to_static_models(self, monkeypatch):
        ...
        monkeypatch.setattr("earl_cli.models.fetch_api_models", lambda api_key, base_url: None)
...
class TestGmiProvidersModule:
    def test_overlay_exists(self):
        ...
        assert "gmi" in EARL_OVERLAYS
        overlay = EARL_OVERLAYS["gmi"]
...
class TestGmiDoctor:
    ...
    def test_run_doctor_checks_gmi_models_endpoint(self, monkeypatch, tmp_path):
        from earl_cli import doctor as doctor_mod
...
class TestGmiMainFlow:
    def test_chat_parser_accepts_gmi_provider(self, monkeypatch):
        ...
        monkeypatch.setattr("earl_cli.config.get_container_exec_info", lambda: None)
        monkeypatch.setattr(
            "earl_cli.main.cmd_chat",
    ...
    def test_select_provider_and_model_routes_gmi_to_generic_flow(self, monkeypatch):
        ...
        monkeypatch.setattr("earl_cli.auth.resolve_provider", lambda *args, **kwargs: None)
        ...
        monkeypatch.setattr("earl_cli.main._model_flow_api_key_provider", fake_model_flow_api_key_provider)
