...
- Profile-scoped reset (uses EARL_HOME)
"""
...
def memory_env(tmp_path, monkeypatch):
    """Set up a fake EARL_HOME with memory files."""
...
def _run_memory_reset(target="all", yes=False, monkeypatch=None, confirm_input="no"):
    ...
    """
    from earl_constants import get_hermes_home, display_hermes_home
...
class TestMemoryReset:
    ...
    def test_reset_profile_scoped(self, tmp_path, monkeypatch):
        """Reset should work on the active profile's EARL_HOME."""
