...
def _isolate_hermes_home(tmp_path, monkeypatch):
    """Redirect EARL_HOME to a temp directory."""
    monkeypatch.setenv("EARL_HOME", str(tmp_path))
    try:
        import earl_constants
        monkeypatch.setattr(earl_constants, "get_hermes_home", lambda: tmp_path)
...
def _create_test_db(db_path, session_id, messages):
    """Create a minimal SQLite DB mimicking earl_state schema."""
