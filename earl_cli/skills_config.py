"""
Skills configuration for Earl Agent.
`earl skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.earl/config.yaml under:
...
from earl_cli.config import cfg_get, load_config, save_config
from earl_cli.colors import Colors, color
from earl_cli.platforms import PLATFORMS as _PLATFORMS
