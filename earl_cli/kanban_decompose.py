...
Invoked by ``earl kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Earl Agent board.
...
def _profile_author() -> str:
    """Mirror of ``earl_cli.kanban._profile_author``."""
    return (
