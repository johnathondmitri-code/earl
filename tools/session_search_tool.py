...
the get_anchored_view / get_messages_around primitives in earl_state.
...
# Third-party integrations tag their sessions with EARL_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from earl_state import DEFAULT_DB_PATH
