...
Trust levels:
  - builtin:   Ships with Earl. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.earl/\.env|\~/\.earl/\.env',
     "earl_env_access", "critical", "exfiltration",
     "directly references Earl secrets file"),
    ...
    (r'\.earl/config\.yaml|\.earl/SOUL\.md',
     "earl_config_mod", "critical", "persistence",
     "references Earl configuration files directly"),
