# Streaming LLM Response Support for Earl Agent
...
```
EARL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("EARL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `earl_cli/config.py` | 1 | +streaming config defaults |
