...
def _profile_user_agent() -> str:
    """Return a ``earl-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from earl_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"earl-cli/{_ver}"
    except Exception:
        return "earl-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # earl-cli UA so the catalog endpoint is reachable.
