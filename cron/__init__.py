"""
Cron job scheduling system for Earl Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    earl gateway install    # Install as a user service
    sudo earl gateway install --system  # Linux servers: boot-time system service
    earl gateway            # Or run in foreground
